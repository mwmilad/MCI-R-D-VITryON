...
class FeatureExtraction(nn.Module):
    def __init__(self, input_nc, ngf=64, n_layers=5, norm_layer=nn.BatchNorm2d, use_dropout=False):
        ...
        for i in range(n_layers):
            ...
            downconv = nn.Conv2d(in_ngf, out_ngf, kernel_size=4, stride=2, padding=1) # i change this line stride = 2
...
class GMM(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.extractionA = FeatureExtraction(29, ngf=64, n_layers=3, norm_layer=nn.BatchNorm2d) 
    ...
    def forward(self, inputA, inputB):
        ...
        # print(f"Feature A and B shape : {featureA.shape, featureB.shape}")
        # print(f"Feature correlation shape : {correlation.shape}")
